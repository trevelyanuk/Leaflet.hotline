 ...
 */
  ...
  Hotline.prototype = {
	 ...
	 */
    _drawOutline(ctx) {
      let i; let j; let dataLength; let path; let pathLength; let pointStart; let
        pointEnd;
	 ...
	 */
    _drawHotline(ctx) {
      let i; let j; let dataLength; let path; let pathLength; let pointStart; let pointEnd;
      let gradient; let gradientStartRGB; let
        gradientEndRGB;
  ...
  L.Hotline = L.Polyline.extend({
    ...
    _clipPoints() {
      ...
      let i; let j; let k; let len; let len2; let segment; let
        points;
